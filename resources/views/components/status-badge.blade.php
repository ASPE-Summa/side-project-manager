...
@elseif($status == ProjectStatus::STARTED)
    <span
        class="inline-flex items-center rounded-md bg-dark-blue px-2 py-1 text-xs font-medium text-primary inset-ring inset-ring-blue-400/30">
        STARTED
    </span>
@elseif($status == ProjectStatus::IN_PROGRESS)
    <span
        class="inline-flex items-center rounded-md bg-dark-green px-2 py-1 text-xs font-medium text-success inset-ring inset-ring-green-500/20">
        IN_PROGRESS
    </span>
